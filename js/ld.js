(function() {
    try {
        ...
        !function(O) {
            ...
            w.Fetch = "Fetch",
            w.Frame = "Frame",
            (w = p = p || {}).OneTagStatic = "OneTagStatic",
            w.OneTagDynamic = "OneTagDynamic",
            ...
            a.getQueryString = function(t) {
                ...
                try {
                    ...
                    i && (t = a.getAnchorWithReferrer(i.document)) && (n = t.search)
                }
                return n
            }
            ,
            ...
            ,
            a.onDocumentReady = function(n, i) {
            ...
            n.prototype.registerTrigger = function(e) {
                var t;
                this.isFeatureAllowed("attribution-reporting") && ((t = this.document.createElement("img")).setAttribute("style", "display:none;"),
                t.setAttribute("width", "1"),
                t.setAttribute("height", "1"),
                t.setAttribute("attributionsrc", n.ATTRIBUTION_TRIGGER_URL_PREFIX + "?" + e),
                e = this.document.getElementsByTagName("script")[0],
                t.setAttribute("data-owner", "criteo-tag"),
                e.parentNode.insertBefore(t, e),
                d.removeLater(this.exceptionHandler, t))
            }
            ,
            ...
            var f, H = "5.42.0", u = ((w = f = f || {})[w.None = 0] = "None",
            w[w.Cookie = 1] = "Cookie",
            w[w.LocalStorage = 2] = "LocalStorage",
            w[w.Library = 3] = "Library",
            i.checkLocalStorageIsWritable = function() {
                try {
                    var e, t, n;
            ...
            ,
            i.checkCookiesAreWritable = function() {
                var e = new i("criteo_write_test",1e4)
            ...
            ,
            i.prototype.setCookieRead = function() {
                this.isCookieRead = !0
            }
            ,
            ...
            ,
            i.prototype.setValueFromExistingCookie = function() {
                var e = this.getValue();
            ...
            ,
            i.prototype.setValueFromAllStorages = function() {
            ...
            ,
            i.prototype.removeFromAllStorages = function() {
                this.removeOnMainDomain(),
                this.tryRemoveFromLocalStorage()
            }
            ,
            i.prototype.setValueWithNoDomainWithExpiration = function(e, t) {
                var n = new Date
            ...
            ,
            i.prototype.setValueWithNoDomain = function(e) {
                this.setValueWithNoDomainWithExpiration(e, this.cookieRetentionTimeInMs)
            }
            ,
            i.prototype.toFragmentData = function() {
                return {
            ...
            ,
            i.prototype.setOnMainDomainWithExpiration = function(e, t) {
            ...
            ,
            i.prototype.computeStorageOrigin = function(e, t) {
                var n = f.None;
                return e && (n |= f.Cookie),
                t && (n |= f.LocalStorage),
                n
            ...
            ,
            i.prototype.getMatchingKeyInAllStorage = function(e) {
            ...
            ,
            i.prototype.tryReadFromLocalStorage = function() {
                var e, t;
                try {
            ...
            ,
            i.prototype.tryRemoveFromLocalStorage = function() {
                try {
            ...
            ,
            i.prototype.tryWriteInLocalStorage = function(e) {
                var t, n;
                try {
            ...
            var m, q = "OneTag", G = ["color: #fff;", "background: #ff4f00;", "display: inline-block;", "padding: 1px 4px;", "border-radius: 3px;"].join(" "), F = ((w = m = m || {})[w.Off = 0] = "Off",
            w[w.Error = 1] = "Error",
            ...
            s.setLogLevel = function(e) {
                s.level = e,
                this.debug("Log level set to " + m[e])
            }
            ,
            s.setUseHeader = function(e) {
                this.useHeader = e
            }
            ,
            s.debug = function() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                s.log(console.log, m.Debug, e)
            }
            ,
            s.info = function() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                s.log(console.log, m.Info, e)
            }
            ,
            s.warn = function() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                s.log(console.warn, m.Warning, e)
            }
            ,
            s.error = function() {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                s.log(console.error, m.Error, e)
            }
            ,
            s.log = function(e, t, n) {
                t <= s.level && (t = 0 < (t = window.navigator.userAgent).indexOf("MSIE ") || 0 < t.indexOf("Trident/") ? ["[" + q + "]"] : ["%c" + q, G],
            ...
            ,
            g.criteoPartnerId = 203,
            g.retryIntervalMs = 100,
            g.maxWaitForApiMs = 2e4,
            g.localStorageKey = "criteo-id5id-fast-track";
            var B = g;
            function g(e) {
            ...
            z.prototype.isStepAllowed = function(t) {
                return !this.blockedSteps.some(function(e) {
                    return e == t
                })
            }
            ,
            Object.defineProperty(z.prototype, "account", {
                get: function() {
            ...
            z.prototype.onAccountChange = function(e) {
                this.observableAccounts.onPropertyChange(e)
            }
            ;
            var Q = z;
            function z() {
                this.firstPartyIdentifier = h("fpIdentifier") || null,
                this.customerInfo = [],
                this.extraData = [],
                this.handlerParams = {
                    v: H
                ...
                this.tagVersion = H,
                this.dynamic = h("dynamic") || null,
                this.fullUrlMaxLength = h("fullUrlMaxLength", 4e3),
                this.previousUrlMaxLength = h("previousUrlMaxLength", 400),
                this.privateModeDetectionEnabled = h("privateModeDetectionEnabled", !0),
                this.blockedSteps = h("blockedSteps", []),
                this.excludedReferrerParams = h("excludedReferrerParams", []),
                this.observableAccounts = new V(h("partnerId") || null)
            }
            v.prototype.getReadyToRetrieveProvider = function() {
            ...
            y.prototype.getCMPFrame = function() {
            ...
            ,
            y.prototype.pingWithTimeout = function(i, e, t, n) {
                function o(e, t) {
                    r.logger(t),
                    clearTimeout(e),
                    n()
            ...
            ,
            y.prototype.retrieveConsent = function(e) {
                this.executeRetrieveConsent("getConsentData", null, e)
            }
            ,
            y.prototype.retrieveConsentForPassback = function(e) {
                this.executeRetrieveConsent("getVendorConsents", [91], e)
            }
            ,
            y.prototype.executeRetrieveConsent = function(e, t, n) {
                var i = this
                  , o = !1
            ...
            ,
            y.prototype.processConsentData = function(e, t) {
                var n;
                e ? (n = {},
            ...
            ,
            y.prototype.executeCommand = function(e, t, n) {
                var i, o = this;
                ...
                this.currentWindow.addEventListener("message", function(e) {
                    var e = "string" == typeof e.data ? K(e.data) : e.data;
            ...
            (w = C = C || {}).LOADED = "tcloaded",
            w.UI_SHOWN = "cmpuishown",
            w.USER_ACTION_COMPLETE = "useractioncomplete",
            ...
            ,
            b.prototype.pingWithTimeout = function(n, e, t, i) {
                function o(e, t) {
                    r.logger(t),
                    clearTimeout(e),
                    i()
            ...
            b.prototype.retrieveConsent = function(n) {
                var i, o, r = this, a = !1, s = window.setTimeout(function() {
                    a = !0,
                    o === C.UI_SHOWN ? (r.logger("Timeout: User hasn't confirm their consent settings after " + r.timeout + "ms"),
                ...
                this.executeCommand("addEventListener", 2, function(e, t) {
                    clearTimeout(c),
                    a || ((o = e.eventStatus) !== C.UI_SHOWN && clearTimeout(s),
                    t ? (r.logger("TCFv2 consent retrieved in ms"),
                    e || (r.logger("Unable to read GDPR consent data from CMP"),
                    n(void 0)),
                    i = r.processResponseData(e),
                    (!1 === e.gdprApplies && void 0 === o || o === C.LOADED || o === C.USER_ACTION_COMPLETE) && n(i)) : (r.logger("Error retrieving TCFv2 consent data from CMP"),
                    n(void 0)))
                })
            }
            ,
            ...
            ,
            b.prototype.executeCommand = function(e, t, n, i) {
                var o, r = this;
                ...
                this.currentWindow.addEventListener("message", function(e) {
                    ...
                    e.returnValue.eventStatus !== C.UI_SHOWN) && delete r.cmpCallbacks[e.callId]
                }, !1)),
            ...
            k.prototype.getCMPFrame = function() {
                for (var e, t = this.currentWindow, n = 0; n < 10; ++n) {
                    try {
            ...
            ,
            k.prototype.hasCallerFunctionInWindow = function() {
                return "function" == typeof this.currentWindow.__uspapi
            }
            ,
            k.prototype.readyToRetrieve = function() {
                return this.hasCallerFunctionInWindow() || void 0 !== this.getCMPFrame()
            }
            ,
            k.prototype.retrieveConsent = function(n) {
                var i = this
                  , o = !1
                  , r = window.setTimeout(function() {
                    o = !0,
            ...
            ,
            k.prototype.processResponseData = function(e, t) {
                e ? t(e) : (this.logger("Unable to read CCPA consent data from CMP"),
                t(void 0))
            }
            ,
            k.prototype.executeCommand = function(e, t, n) {
                var i, o = this;
            ...
            ,
            k.prototype.hasUserOptOut = function(e) {
            ...
            P.prototype.getCMPFrame = function() {
                for (var e, t = this.currentWindow, n = 0; n < 10; ++n) {
                    try {
            ...
            function S() {
                var t = this;
                this.lastValue = S.unsetValue,
                this.hasValue = new Promise(function(e) {
                    return t.resolveHasValue = e
                }
                )
            }
            ne.prototype.retrieveConsent = function() {
                return this.consentWrapper.getLast()
            }
            ,
            ne.prototype.updateConsent = function() {
                return l(this, void 0, void 0, function() {
            ...
            function ne(e, t) {
                ...
                this.tcfCompatibleConsentProvider = new J(new Y(e,s,F.info),new $(e,s,F.info),F.info),
                this.ccpaConsentProvider = new X(e,a,F.info),
                this.gppConsentProvider = new Z(e,i,F.info),
                this.consentWrapper = new ee,
                this.updateConsent(),
            ...
            function T(e) {
                ...
                if (e instanceof Function)
                    return (t = e())instanceof Function ? t : T(t);
                if (e instanceof Array)
            ...
            function ae(e, t) {
                for (var n = 0, i = e; n < i.length; n++) {
                    var o = i[n];
                    if (o.event === t.event && I(t.account, o.account)) {
                        for (var r in t)
            ...
            function se(e, t) {
                for (var n = 0, i = e; n < i.length; n++) {
                    var o = i[n];
                    if (o.event === t.event && I(t.account, o.account) && o.hash_method === t.hash_method)
            ...
            function ce(e, t) {
                for (var n = 0, i = e; n < i.length; n++) {
                    var o = i[n];
                    if (o.event === t.event && void 0 === t.account && void 0 === o.account || I(t.account, o.account)) {
                        for (var r in t)
                            t.hasOwnProperty(r) && "account" !== r && (o[r] = t[r]);
                        return
                    }
            ...
            var pe = de;
            function de() {}
            fe.prototype.getJsonForQueryString = function() {
                var e, t = {
            ...
            D.prototype.checkCookies = function(e) {
                ...
                if (e.callbacks) {
                    for (var n = 0, i = "string" == typeof e.callbacks ? [e.callbacks] : e.callbacks; n < i.length; n++) {
                        ...
                        d.removeLater(this.exceptionHandler, r)
                    }
                    t = !1
                }
            ...
            ,
            _.prototype.scrapIdentifiers = function(e) {
                return ""
            }
            ;
            var ge = _;
            ...
            ye.prototype.createIframe = function(e, t, n, i, o) {
                var r = document.createElement("iframe")
                  ...
                  , s = d.getHighestAccessibleUrl(window)
                  , a = a(d.extractHostname(s))
                ...
                h("styleIframes", !(r.hidden = !0)) && (r.style.display = "none"),
            ...
            function ye() {
                ...
                this.gumSyncFrameOrigin = "https://" + h("gumDomain", "gum.criteo.com"),
                ...
                this.enableOffsiteProjection = h("enableOffsiteProjection", !0),
                this.waitingForSyncframe = this.enableOffsiteProjection,
                this.requestId = pe.generateUUID()
            }
            we.prototype.createIframe = function(e, t, n, i, o) {
                return document.createElement("iframe")
            }
            ,
            we.prototype.setWaitingFlag = function(e) {}
            ,
            we.prototype.shouldInjectSyncframe = function() {
                return !1
            }
            ;
            var Ce = we;
            ...
            var be = new RegExp(/^Mozilla\/5\.0 \([^)]+\) AppleWebKit\/[^ ]+ \(KHTML, like Gecko\) Version\/([^ ]+)( Mobile\/[^ ]+)? Safari\/[^ ]+$/i)
              , ke = (E.prototype.canRetrieveMetrics = function() {
            ...
            x.prototype.init = function() {
                var t = this;
                h("smartPiiCollectionEnabled", !1) && (this.exceptionHandler.addProtectedEventListener(this.document, "click", function(e) {
                    e = e.target;
            ...
            x.prototype.scanFormInputs = function(e) {
                ...
                return e.forEach(function(e) {
                    ...
                    if (t && !(t.length < 6)) {
                        var n = h("smartPiiCollectionBlocklist", [])
            ...
            function M() {
                ...
                this.isCbsEnabled = !1,
                this.uat = void 0,
                this.shouldFillPageId = h("shouldFillPageId", !0)
            }
            Object.defineProperty(Te.prototype, "accounts", {
                get: function() {
                    return this.observableAccounts.get()
                },
                enumerable: !1,
            ...
            Te.prototype.onAccountsChange = function(e) {
                this.observableAccounts.onPropertyChange(e)
            }
            ;
            var Ie = Te;
            function Te() {
                ...
                this.eventSent = !1,
                this.queue = [],
                this.observableAccounts = new V([])
            }
            var Re = /^#(enable|disable)-criteo-tag-debug-mode(=(\d+))?$/;
            function De(e, t, n, i, o) {
                var r, a, s, c;
                return document && window.location.hash && (a = Re.exec(window.location.hash)) && 4 === a.length && (r = "enable" === a[1],
                a = Number(a[3]),
            ...
            L.prototype.removeLater = function(e) {
                d.removeLater(this.exceptionHandler, e)
            }
            ,
            ...
            L.prototype.evalEvent = function(f, m, g, v) {
                return l(this, void 0, void 0, function() {
                    ...
                    return A(this, function(e) {
                        ...
                        switch (f.event) {
                        case "setdata":
                            return [2, R(o.extraData, t.actions, f)];
                        case "setparameter":
                            for (u in f)
                        ...
                        case "setretailervisitorid":
                            return n.enable(),
                            f.event = "setdata",
                            f.retailer_visitor_id = f.id,
                            delete f.id,
                            [2, R(o.extraData, t.actions, f)];
                        case "setgoogleadvertisingid":
                            return i.gaid = f.gaid,
                            [2, R(o.extraData, t.actions, {
                                event: "setdata",
                                site_type: "aa"
                            })];
                        ...
                        case "setsha256hashedphonenumber":
                            return f.hasOwnProperty("phone_number") && 0 < (l = re(l = f.phone_number instanceof Array ? f.phone_number : [f.phone_number])).length ? (p = "setphonenumber" == f.event ? "pnclear" : "pnsha256",
                            d = {
                                source: "onetag",
                            ...
                            [2, 1]) : [2, 0];
                        case "setidentity":
                            return f.hasOwnProperty("identity") && 0 < (d = re(f.identity instanceof Array ? f.identity : [f.identity])).length ? (f.identity = d,
                            t.actions.push(T(f)),
                            [2, 1]) : [2, 0];
                        case "setsitetype":
                            return h = "d",
                        ...
                        return t.actions.push(T(f)),
                        [2, 1]
                    })
                })
            }
            ,
            L.prototype.flush = function(D) {
                return l(this, void 0, void 0, function() {
                    var a, s, c, u, l, p, d, h, f, m, g, v, y, C, w, b, k, P, S, I, T, R;
                    return A(this, function(e) {
                        switch (e.label) {
                        case 0:
                            ...
                            y = a.actions; v < y.length; v++)
                                ...
                                delete o.identity);
                            if (!u.manualDising && (!D || u.partialDis)) {
                                for (w = [],
                                b = 0,
                                k = a.accounts; b < k.length; b++)
                                    P = k[b],
                                    oe(a.disingScheduled, P) || w.push(P);
                        ...
                        case 6:
                            ...
                            T = this.generateQueryString(S),
                            R = this.buildHandlerCall(T),
                            "function" == typeof l.onUrlGenerated ? l.onUrlGenerated(R.url) : "beacon" === c.requestType && navigator.sendBeacon ? navigator.sendBeacon(R.url) : this.evalAppendTagEvent(R),
                            F.info("DIS call triggered", R.url, S),
                            (a.eventSent = !0) === R.isImgUrl && this.mAttributionReporting.registerTrigger(T),
            ...
            L.prototype.beforeEvalEvent = function(e) {
                ...
                e.event ? (e.account && ie(e.account, this.mState.app.accounts, function(e) {
            ...
            L.prototype.innerEvalCallDisingEvent = function(e) {
                ...
                delete e.type),
                ie(e.account, this.mState.app.disingScheduled),
                "sequential" === t && (e.dc = !0)
            }
            ,
            L.prototype.innerEvalAppendTagEvent = function(e) {
                var t = this.mConfig.workflow;
                if (!this.mState.app.bodyReady || t.container && document.body.contains(t.container) || (t.container = d.appendCriteoContainer(document.body)),
                e.url && (n = void 0,
                ...
                e.element && (e.element.tagName || e.isImgUrl)) {
                    ...
                    d.removeLater(this.exceptionHandler, e.element)
                }
                return 1
            }
            ,
            L.prototype.evalCallDisingEvent = function(e) {
                ...
                this.mState.app.actions.push(T(e)),
                1)
            }
            ,
            L.prototype.getQueryParams = function() {
                ...
                for (var o = 0; o < n.length; ++o) {
                    var r = n[o];
                    r.account && I(null === t.account ? void 0 : t.account, r.account) && delete r.account,
                ...
                var a = d.getHighestAccessibleUrl(window)
                  , a = (_e(this.maybeRemoveQueryParams(a, t), i, t.fullUrlMaxLength, "fu", "ful"),
                t.isStepAllowed("readPreviousUrl") && (e = d.getPreviousUrl(window),
                _e(e = this.maybeRemoveQueryParams(e, t), i, t.previousUrlMaxLength, "pu", "pul")),
                pe.generateUUID())
            ...
            L.prototype.setupCspLogger = function() {
                ...
                h("enabledCspViolationDetection", !0) && (this.addExtraAllowedDomainsToCspLogger(),
                this.cspLogger.registerListener())
            }
            ,
            L.prototype.addExtraAllowedDomainsToCspLogger = function() {
                var e = h("allowedDomainsForCsp", []);
                this.cspLogger.addAllowedDomains(e)
            }
            ;
            var Fe = L;
            function L() {
                var e, t, n, i, o, r, a, s = this, c = (void 0 !== (null == (r = null === window || void 0 === window ? void 0 : window.location) ? void 0 : r.hash) && -1 !== window.location.hash.indexOf("onetag-debug") && F.setLogLevel(m.Debug),
                this.exceptionHandler = new j,
                this.exceptions = this.exceptionHandler.exceptions,
                this.performanceMetrics = new ke,
                ...
                h("addClientSideSupportForId5") && (c = h("useStaticConsentForId5", !1),
                e = new B(c),
                ...
                this.mIdentification = c ? new me(this.exceptionHandler,u,window,this.mConfig) : new ge,
                this.mSyncframe = new (c ? ve : Ce),
                this.mConsentManager = new te(window),
                this.mAttributionReporting = new N(document,this.exceptionHandler),
                ...
                this.exceptionHandler.catchAndStoreException(function() {
                    ...
                    d.onBodyReady(s.exceptionHandler, function() {
                    ...
                    d.onDocumentReady(s.exceptionHandler, function() {
                        return l(s, void 0, void 0, function() {
                            return A(this, function(e) {
                                switch (e.label) {
                                case 0:
                    ...
                    try {
                        var t = d.getAnchorWithReferrer(document);
                        t && t.hostname !== document.location.hostname && ce(e, {
                            event: "setData",
                            ref: t.protocol + "//" + t.hostname
                        })
                    } catch (e) {}
                    h("visitEventEnabled", !1) && Ae(s, s.mState.app, s.mConfig.trackingCallData),
                    new Pe(document,s,s.mConfig.trackingCallData,s.exceptionHandler).init()
                })
            }
            ...
            function Ee(e) {
                ...
                e.criteo_q = De({
                    exceptions: (n = new Fe).exceptions,
