!function(t) {
    ...
    function i(n) {
        ...
        t[n].call(e.exports, e, e.exports, i),
        e.l = !0,
        e)).exports
    }
    i.m = t,
    ...
    try {
        ...
        (i = document.createElement("meta")).httpEquiv = "origin-trial",
        i.content = r,
...
, function(n, e, t) {
    ...
    function o(n) {
        n.version = c,
        100 * Math.random() < (r.LIST.SEND_LOGS.chance || 0) && i.v(n)
    }
    ...
    function t(n, e) {
        return function(n) {
            ...
            if (null != t) {
                var r, i, c = [], o = !0, a = !1;
                try {
                    for (t = t.call(n); !(o = (r = t.next()).done) && (c.push(r.value),
                    !e || c.length !== e); o = !0)
                        ;
                } catch (n) {
                    a = !0,
            ...
            var t;
            if (n)
                return "string" == typeof n ? r(n, e) : "Map" === (t = "Object" === (t = Object.prototype.toString.call(n).slice(8, -1)) && n.constructor ? n.constructor.name : t) || "Set" === t ? Array.from(n) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? r(n, e) : void 0
        }(n, e) || function() {
